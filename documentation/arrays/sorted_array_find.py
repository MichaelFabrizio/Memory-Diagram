...
_drawing = drawing.Drawing(diagram_width = 11., diagram_height = 4., show_axes = True, horizontal_elements = 10, vertical_elements = 1, lower_padding = 0.75, upper_padding = 0.75, left_padding = 0.1, show_axes_numbers = False)
